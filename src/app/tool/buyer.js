...
async function main() {
  ...
  try {
    ...
    console.log('\n[2] Initial Balances:');
    await showBalances(client, treasuryWallet.address, buyerWallet.address, walletInfo.bond.name);
    ...
    console.log(`  Offer created: ${sellOffer.tokenAmount} tokens for ${sellOffer.xrpTotal} XRP`);
    ...
    console.log(`  Trade executed: ${buyOffer.tokenAmount} tokens for ${buyOffer.xrpTotal} XRP`);
    ...
    console.log(`Net XRP spent: ${(tokensToBuy - tokensToSellBack) * TOKEN_PRICE_XRP} XRP`);
